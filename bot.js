// Botu Açık Tutma amq cons Discord = require('discord.js') nin altında olması lazım 
...
fs.writeFile('./xp.json', JSON.stringify(points), (err) => {
  ...
  if (message.content.toLowerCase() === prefix + 'level' || message.content.toLowerCase() === prefix + 'profil' || message.content.toLowerCase() === prefix + 'seviye') {
...
client.on('message', async msg => {
    ...
    .setTitle(':warning: | İlk olarak sesli bir kanala giriş yapmanız gerek.'));
      ...
      .setTitle(`**✅ | Oynatma Listesi: **${playlist.title}** Kuyruğa Eklendi!**`)
         ...
         .setTitle('Kodlama Sanatı | Şarkı Seçimi')
   ...
   .setTitle(`:warning: Şuanki Ses Seviyesi: **${serverQueue.volume}**`)
    ...
    .setColor('RANDOM'));
		  return msg.channel.sendEmbed(new Discord.RichEmbed()
    .setColor('RANDOM')
     .setTitle('CrosslandBot | Şarkı Kuyruğu')
...
function play(guild, song) {
  ...
  .setTitle("**CrosslandBot | 🎙 Müzik Başladı**",`https://cdn.discordapp.com/avatars/473974675194511361/6bb90de9efe9fb80081b185266bb94a6.png?size=2048`)
...
const dmembed = new Discord.RichEmbed()
	.setTitle("⚠ **| Sunucunda** " + msg.author.tag + " **Reklam Yapıyor !!**")
      .setColor(0xFF0000)
      .setDescription("\`d!uyar <@kişi>\` **Komutu İle Onu Uyarabilir Yada** \`d!kick <@kişi>\` *Veya** \`d!ban <@kişi>\` \n**Komutlarını Kullanarak Onu Sunucudan Uzaklaştırabilirsin !!**")
